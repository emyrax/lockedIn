    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute inset-0 opacity-[0.03]" style={{
          backgroundImage: 'radial-gradient(circle at 30% 40%, #059669 2px, transparent 2px), radial-gradient(circle at 70% 60%, #D97706 1px, transparent 1px)',
      ...
      >
        <div className="glass-card-dark p-6 lg:p-8 text-center relative overflow-hidden group transition-all duration-300"
            ...
            >
              <div>
                ...
                <div className="relative group/input">
                  <i className="fas fa-id-card absolute left-3 top-1/2 -translate-y-1/2 text-xs transition-colors duration-300" style={{ color: 'rgba(255,255,255,0.25)' }} />
              ...
              <div>
                ...
                <div className="relative group/input">
                  <i className="fas fa-lock absolute left-3 top-1/2 -translate-y-1/2 text-xs transition-colors duration-300" style={{ color: 'rgba(255,255,255,0.25)' }} />
